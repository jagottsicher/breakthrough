...
func DefaultTheme() Theme {
	return Theme{
		...
		EntryNormal:     "white",
		EntryExecutable: "forestgreen", // an explicit RGB rather than the terminal palette's own index-2 green, which many emulators render bright enough to glare against the dark panel
		EntryError:      "red",
		EntrySymlink:    "aqua",
		EntrySpecial:    "orange",
